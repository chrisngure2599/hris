...
<!--          <td class="pt-3-half">
          ...
          <td>
              <span class="table-editable"><button type="button" class="btn btn-info  btn-rounded btn-sm my-0"><a href="edit.php? id=<?php echo $row['id']; ?>" class="edit_btn" name="edit" >Edit</a></button></span>
          </td>
          <td>
